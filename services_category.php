<?php
$amp = ["have"=>false, "page"=>"services_category"];
                ...
                <div class="row">
                    <div class="col-xs-12 col-lg-8" itemprop="articleBody">
                        ...
                        <div class="row section_services_list">
                            <?php for($i=0;$i<6;$i++){ 
                                include "view/services_item.php";
                            } ?>
                        </div>
